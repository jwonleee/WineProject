...
import WhiteWineList from '../JW/WhiteWhineList';
import WhiteWinePagination from '../JW/WhiteWinePagination';
import WhiteWineList2 from './WhiteWhineList2';
  ...
  const [dataPerPage, setDatasPerPage] = useState(12); /* 12개씩 보여줄 데이터 관리 */
    ...
    return (
      <div>
        ...
        <WhiteWineList2 data={currentDatas(data)} />
